...
$form['form-1'] = array(
	'fields' => array(
		...
		'e-mail' => array(
			...
			'messages' => array(
				'preg' => 'Field [%1$s] probably contains an error',
				'minlength' => 'The minimum length of the field [%1$s] less permissible -%2$s',
			)
		),
		'text' => array(
			'title' => 'Zipcode',
		...
		'name' => array(
			...
			'messages' => array(
				'preg' => 'Field [%1$s] probably contains an error',
				'minlength' => 'The minimum length of the field [%1$s] less permissible -%2$s',
				'maxlength' => 'Maximum field length [%1$s] exceeds the permissible -%2$s',
			)
		),
		'name2' => array(
			'title' => 'Last name',
	...
	'cfg' => array(
		...
		'title' => 'Заголовок в теле письма 1',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@email.com',
		'from_name' => 'noreply',
		'to_email' => 'info@zoorni.com',
		'to_name' => 'zoorni',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
...
$form['form-3'] = array(
	...
	'cfg' => array(
		...
		'title' => 'Заголовок в теле письма 2',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'noreply@email.com',
		'from_name' => 'noreply',
